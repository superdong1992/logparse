...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("work_dir", type=Path, help="Directory containing result.txt and used process logs")
    parser.add_argument("output_zip", type=Path, help="Path to write result.zip")
